      ...
      <div className="flex min-h-[80vh] items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        <Card className="w-full max-w-md">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription>
              Inscrivez-vous dès maintenant pour suivre votre progression sur
              Flow.
            </CardDescription>
          </CardHeader>

          {apiError && (
            <div className="bg-destructive/10 text-destructive mx-6 flex items-center gap-2 rounded-md p-4">
